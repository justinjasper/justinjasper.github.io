...
<div class="row justify-content-sm-center">
  <div class="col-sm-10 mt-3 mt-md-0">
    {% include figure.liquid loading="eager" path="assets/img/intercostalNerve.png" title="Intercostal nerve anatomy under the costal groove" class="img-fluid rounded z-depth-1" %}
  </div>
</div>
<div class="caption">
  The intercostal nerve bundle runs beneath the costal groove at the inferior margin of the rib—making it vulnerable to compression from conventional rib retraction.
</div>
...
<div class="row">
  <div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid loading="eager" path="assets/img/fig1.5a.png" title="Final retractor prototype (sketch)" class="img-fluid rounded z-depth-1" %}
  </div>
  <div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid loading="eager" path="assets/img/fig1.5b.png" title="Final retractor prototype (physical)" class="img-fluid rounded z-depth-1" %}
  </div>
</div>
<div class="caption">
  Figures 1.5a–b: Final retractor prototype showing intracostal prongs designed to anchor within drilled rib holes (1.5a sketch; 1.5b physical prototype).
</div>
...
<div class="caption">
  Figure 1.5c: Intraoperative testing in a pig model, illustrating drilling, prong insertion, and rib spreading without intercostal nerve contact.
</div>

<div class="row justify-content-sm-center">
  <div class="col-sm-10 mt-3 mt-md-0">
    {% include figure.liquid loading="eager" path="assets/img/fig1.5d.png" title="CT reconstruction confirming hole placement" class="img-fluid rounded z-depth-1" %}
  </div>
</div>
<div class="caption">
  Figure 1.5d: 3D reconstructed CT scans confirming precise, parallel, and equidistant hole placement across ribs using the drill guide.
</div>
